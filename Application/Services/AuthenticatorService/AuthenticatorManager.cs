...
using MimeKit;
using DotNetMatic.Core.CrossCuttingConcerns.Exception.Types;
using DotNetMatic.Core.Mailing;
using DotNetMatic.Core.Security.EmailAuthenticator;
using DotNetMatic.Core.Security.Enums;
using DotNetMatic.Core.Security.OtpAuthenticator;
...
public class AuthenticatorManager : IAuthenticatorService
{
    ...
    private async Task SendAuthenticatorCodeWithEmail(User user)
    {
        ...
        _mailService.SendMail(
            ...
            {
                ToList = toEmailList,
                Subject = "Authenticator Code - DotNetMatic",
