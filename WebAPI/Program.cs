...
using DotNetMatic.Core.CrossCuttingConcerns.Exception.WebApi.Extensions;
using DotNetMatic.Core.CrossCuttingConcerns.Logging.Configurations;
using DotNetMatic.Core.ElasticSearch.Models;
using DotNetMatic.Core.Localization.WebApi;
using DotNetMatic.Core.Mailing;
using DotNetMatic.Core.Persistence.WebApi;
using DotNetMatic.Core.Security.Encryption;
using DotNetMatic.Core.Security.JWT;
using DotNetMatic.Core.Security.WebApi.Swagger.Extensions;
using Persistence;
